...
![](/img/Netlify_Site_Settings.PNG)  
![](/img/Netlify_Identity_Reg_pref_providers.PNG)  
...
to your homepage, you can just add the following to the body of your layout page
